...
int main(int argc, char **argv)
{
  ...
  S7200Resources& resources = S7200Resources::GetInstance();

  resources.init(argc, argv);

  S7200Resources::setDriverType(Common::Constants::getDrvName().c_str());
